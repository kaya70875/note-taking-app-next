...
export default function NotChoosed() {
    ...
    return (
        <div className={`content-section w-full flex flex-1 flex-col gap-4 p-4 xs:p-1 lg:p-0 border-r lg:border-none border-neutral-300 dark:border-neutral-700 ${isTablet ? 'hidden' : 'block'}`}>
            {!isTablet ? (
