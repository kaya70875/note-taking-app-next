...
export default function AllNotes({ searchQuery }: AllNotesProps) {
    ...
    return (
        <div className='flex flex-col justify-between items-end h-full min-h-0'>
            <div className="note-cards flex flex-col gap-3 lg:gap-4 overflow-auto w-full"> {/* All notes shown here */}
